...
/*   Updated: 2024/03/30 16:48:13 by akrepkov         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(std::string name){
	...
	_damage = 0;
	_maxXP = _hit;
	std::cout << "\033[2;20;40mOriginal Constructor was called\033[0m\t\t" << std::endl;
}
ClapTrap::~ClapTrap(){
	std::cout << "\033[2;20;40mOriginal Destructor was called\033[0m\t\t" << std::endl;
}
...
ClapTrap::ClapTrap(const ClapTrap& a){
	std::cout << getName() << "\033[2;20;40m Copy constructor was called\033[0m\t\t" << std::endl;
	*this = a;
}
